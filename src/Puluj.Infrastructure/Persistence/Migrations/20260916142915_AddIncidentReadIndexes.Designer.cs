...
namespace Puluj.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916142915_AddIncidentReadIndexes")]
    partial class AddIncidentReadIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.Incident", b =>
                {
                    ...
                    b.Property<double?>("AccuracyKm")
                        .HasColumnType("double precision")
                        .HasColumnName("accuracy_km");

                    b.Property<Guid?>("CanonicalObservationId")
                        .HasColumnType("uuid")
                        .HasColumnName("canonical_observation_id");
                    ...
                    b.Property<int?>("IndependentSourceCount")
                        .HasColumnType("integer")
                        .HasColumnName("independent_source_count");
                    ...
                    b.Property<long?>("MergedIntoIncidentId")
                        .HasColumnType("bigint")
                        .HasColumnName("merged_into_incident_id");
                    ...
                    b.HasIndex("GenerationId")
                        .HasDatabaseName("ix_incidents_generation_id");

                    b.HasIndex("Geometry")
                        .HasDatabaseName("ix_incidents_geometry");
                    ...
                    b.ToTable("incidents", null, t =>
                        {
                            t.HasCheckConstraint("ck_incidents_state", "state IN ('reported', 'confirmed', 'resolved', 'retracted')");
                        });
                });

            modelBuilder.Entity("Puluj.Domain.Entities.IncidentObservation", b =>
                {
                    b.Property<long>("IncidentId")
                        .HasColumnType("bigint")
                        .HasColumnName("incident_id");
                    ...
                    b.Property<JsonDocument>("DecisionReason")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<long?>("LegacyTargetId")
                        .HasColumnType("bigint")
                        .HasColumnName("legacy_target_id");
                    ...
                    b.HasKey("IncidentId", "ObservationId")
                        .HasName("pk_incident_observations");

                    b.HasIndex("ObservationId")
                        .IsUnique()
                        .HasDatabaseName("ix_incident_observations_observation_id");

                    b.ToTable("incident_observations", (string)null);
                });

            modelBuilder.Entity("Puluj.Domain.Entities.IncidentRevision", b =>
                {
                    b.Property<long>("IncidentRevisionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("incident_revision_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IncidentRevisionId"));
                    ...
                    b.HasKey("IncidentRevisionId")
                        .HasName("pk_incident_revisions");

                    b.HasIndex("IncidentId", "Revision")
                        .IsUnique()
                        .HasDatabaseName("ix_incident_revisions_incident_id_revision");

                    b.ToTable("incident_revisions", (string)null);
                });
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.LlmRequest", b =>
                {
                    ...
                    b.HasIndex("RequestId")
                        .HasDatabaseName("ix_llm_requests_request_id");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.Processing.Extraction", b =>
                {
                    ...
                    b.PrimitiveCollection<Guid[]>("LlmRequestIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("llm_request_ids");
                    ...
                    b.HasKey("ExtractionId")
                        .HasName("pk_extractions");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_extractions_created_at");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("CreatedAt"), "brin");

                    b.HasIndex("RawMessageId", "RunId")
                        .IsUnique()
                        .HasDatabaseName("ix_extractions_raw_message_id_run_id");

                    b.ToTable("extractions", "processing");
                });

            modelBuilder.Entity("Puluj.Domain.Entities.Processing.Observation", b =>
                {
                    b.Property<Guid>("ObservationId")
                        .HasColumnType("uuid")
                        .HasColumnName("observation_id");
                    ...
                    b.Property<string>("EventKindCode")
                        .IsRequired()
                        .HasMaxLength(96)
                        .HasColumnType("character varying(96)")
                        .HasColumnName("event_kind_code");
                    ...
                    b.HasIndex("ExtractionId")
                        .HasDatabaseName("ix_observations_extraction_id");

                    b.HasIndex("LegacyTargetId")
                        .HasDatabaseName("ix_observations_legacy_target_id");

                    b.HasIndex("EventKindCode", "EffectiveAt")
                        .HasDatabaseName("ix_observations_event_kind_code_effective_at");

                    b.HasIndex("RawMessageId", "RunId")
                        .HasDatabaseName("ix_observations_raw_message_id_run_id");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.Processing.ProcessingAttempt", b =>
                {
                    ...
                    b.HasIndex(new[] { "JobKey", "FencingToken" }, "ux_processing_attempts_job_token")
                        .IsUnique()
                        .HasDatabaseName("ux_processing_attempts_job_token")
                        .HasFilter("fencing_token > 0");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.Target", b =>
                {
                    ...
                    b.HasIndex("ObservationId")
                        .IsUnique()
                        .HasDatabaseName("ux_targets_observation_id")
                        .HasFilter("observation_id IS NOT NULL");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.Incident", b =>
                {
                    b.HasOne("Puluj.Domain.Entities.EventKind", "EventKind")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_incidents_event_kinds_event_kind_id");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.IncidentObservation", b =>
                {
                    b.HasOne("Puluj.Domain.Entities.Incident", "Incident")
                        .WithMany("Observations")
                        .HasForeignKey("IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_incident_observations_incidents_incident_id");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.IncidentRevision", b =>
                {
                    b.HasOne("Puluj.Domain.Entities.Incident", "Incident")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_incident_revisions_incidents_incident_id");
            ...
            modelBuilder.Entity("Puluj.Domain.Entities.Processing.Observation", b =>
                {
                    b.HasOne("Puluj.Domain.Entities.Processing.Extraction", "Extraction")
                        .WithMany()
                        .HasForeignKey("ExtractionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_observations_extractions_extraction_id");
