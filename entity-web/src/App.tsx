...
import EntityRefreshControl from './entities/EntityRefreshControl'
import { useEntityPolling } from './entities/useEntityPolling'
...
export default function App() {
  ...
  // Entity overlays belong exclusively to the Entity Extractor read side in this fork.
  useEffect(() => {
    if (!activeMap) return
    const store = useStore.getState()
    store.setSnapshot([], [], [])
