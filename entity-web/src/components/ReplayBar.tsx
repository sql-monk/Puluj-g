 ...
 */
export default function ReplayBar({ initialWindow, onHistoryChange, onClose }: { initialWindow: HistoryWindow; onHistoryChange: (window: HistoryWindow) => void; onClose: () => void }) {
  ...
  useEffect(() => {
    ...
    replay.load({ from: from.toISOString(), to: to.toISOString(), tracks: [] })
    setBuckets([])
