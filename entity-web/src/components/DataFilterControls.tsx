...
export default function DataFilterControls({ route }: { route: PublicRoute }) {
  ...
  return <div className="flex flex-col gap-3 text-sm">
    ...
    <Chips filters={filters} onChange={apply} entitySection={entitySection} targetAnalytics={targetAnalytics} sources={dictionary.sources} regions={dictionary.regions} />
