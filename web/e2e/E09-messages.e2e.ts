...
test('public raw-message catalogue and a concrete revision detail remain safe and navigable', async ({ page }) => {
  ...
  await expect(page.getByRole('button', { name: 'Показати на мапі' }).first()).toBeDisabled()
